...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   cliHelper.errorman buildScript v0.1.3
# .DESCRIPTION
#   A custom build script for the module cliHelper.errorman
# .LINK
#   https://github.com/chadnpcQtec/cliHelper.errorman/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
